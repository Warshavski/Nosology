...
MaterialLayout.prototype.init = function () {
    if (this.element_) {
        ...
        if (this.drawer_) {
            ...
            drawerButtonIcon.classList.add(this.CssClasses_.FA_ICON);       //#MY added
            drawerButtonIcon.classList.add(this.CssClasses_.FA_ICON_MENU);  //#MY added
            drawerButtonIcon.classList.add(this.CssClasses_.U_ICON);        //#MY added
